...
https://github.com/pankona/go-wasm-test を実際にこねて出てくるものは以下。

上記リポジトリで make を実行すれば同じものが手に入るはずだが見やすさのため転記。

* Go のリポジトリから取得する類のファイルは頻繁に変更が入っているので、動いた実績のあるコードとして
* 大元を参照するの面倒な人のため
